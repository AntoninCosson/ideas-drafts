...
**How It Works:**
Planning Phase (server-sequential-thinking): The sequential thinking server breaks down the complex task into logical steps:
...
Execution Phase (blender-mcp): Blender MCP executes each step with appropriate Python code
Monitoring Phase: The system checks each modification for quality and makes adjustments as needed

from:
https://blender-mcp.com/index.html#how-it-works
